...
async function main(params) {
  ...
  try {
    ...
    const apiEndpoint = `https://platform.adobe.io/data/core/ups/access/entities?entityId=${params.identityValue}&entityIdNS=${params.identityNamespace}&mergePolicyId=${params.mergePolicyId}&schema.name=_xdm.context.profile&withCA=true`;
