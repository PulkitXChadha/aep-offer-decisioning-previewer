...
async function main(params) {
  ...
  try {
    ...
    const apiEndpoint = `https://platform.adobe.io/data/core/xcore/?property=_instance.containerType==decisioning${
      params.sandboxName
        ? `&property=_instance.parentName==${params.sandboxName}`
        : ``
    }`;
    ...
    const res = await fetch(apiEndpoint, {
      ...
      headers: {
        ...
        Accept: "application/vnd.adobe.platform.xcore.home.hal+json",
      },
    });
    if (!res.ok) {
      throw new Error(
