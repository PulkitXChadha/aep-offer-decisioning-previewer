...
async function main(params) {
  ...
  try {
    ...
    const apiEndpoint = `https://platform.adobe.io/data/core/xcore/${params.containerID}/queries/core/search?schema=https://ns.adobe.com/experience/offer-management/offer-filter;version=0.1`;
