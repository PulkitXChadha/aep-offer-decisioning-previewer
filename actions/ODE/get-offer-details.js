...
async function main(params) {
  ...
  try {
    ...
    const apiEndpoint = `https://platform.adobe.io/data/core/xcore/${params.containerID}/instances?schema=https://ns.adobe.com/experience/offer-management/personalized-offer;version=0.5&id=${params.offerID}`;
